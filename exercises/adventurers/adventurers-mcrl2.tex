...
%
\faded{Alternatively, use the command line tools by
(1) executing the \bash{mcrl22lps} to produce the linearised specification, and (2) executing \bash{lpsxsim} to start a GUI simulation of the resulting linearised specification.}
...
\begin{exercise}
  ...
  \faded{Alternatively, use the \bash{lps2lts} command and visualise the LTS using the \bash{ltsgraph} tool.}
