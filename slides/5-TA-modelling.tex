...
State $\pair{on,\overline{2}}$ \only<1>{$\ldots$}\pause is reachable through path 
$$\pair{off,\overline{0}} \trans{s-on} \pair{on,\overline{0}} \trans{2} \pair{on,\overline{2}}$$
and is terminal
...
State $\pair{on,\overline{2}}$ \only<1>{$\ldots$}\pause is not terminal but has a \structure{convergent} path:

$$\pair{on,\overline{2}} \pair{on,\overline{2.9}}  \pair{on,\overline{2.99}}  \pair{on,\overline{2.999}}  ...$$
...
\begin{equation*}
\pair{off,\overline{0}}  \trans{in}  \pair{on,\overline{0}}  \trans{in}  \pair{on,\overline{0}}  \trans{in}  \pair{on,\overline{0}}  \trans{in}  \pair{on,\overline{0}}  \trans{in} \cdots
\end{equation*}


The user presses $in$ \alert{faster and faster}:
\begin{equation*}
\pair{off,\overline{0}}  \trans{in}   \pair{on,\overline{0}}  \trans{0.5} \pair{on,\overline{0.5}} \trans{in} \pair{on,\overline{0}} \trans{0.25}  \pair{on,\overline{0.25}}   \trans{in} \pair{on,\overline{0}}  \trans{0.125}  \cdots
\end{equation*}
\end{block}
