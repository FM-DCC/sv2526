...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=.4\paperwidth,ht=2.25ex,dp=1ex,center]{author in head/foot}%
    \usebeamerfont{author in head/foot}{System Verification 2025/26 @ FCUP}%\insertshortauthor
  \end{beamercolorbox}%
...
\setbeamertemplate{frametitle}{%
  ...
  \hfill
  \raisebox{-1.3ex}{\includegraphics[height=4ex,keepaspectratio]{images/fcup-bar}}
  \end{beamercolorbox}%
}
\makeatother
