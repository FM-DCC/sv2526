...
\begin{frame}[fragile]{Process Expressions}
  ...
  \\
  \mcode{$\structure{exp}$ -> PE1 <> PE2} \is{If-then-else}
  \end{align*}}
...
\begin{slide}{mCRL2 toolset overview}
  ...
  \begin{block}{}\centering
    % Tutorial: \url{https://dcc-fm.github.io/sv2526/exercises/adventurers/adventurers-tutorial-mcrl2.zip}
    % //
    Assignment 1: ~~ TBA
  % \mbox{\alert{\footnotesize\url{https://fm-dcc.github.io/sv2526/exercises/mcrl2-assignment.zip}}}
  \end{block}
%
  % \\[-4mm]
  % -- mCRL2 tutorial: \alert{Modelling} part --
  % \\
  % \structure{\footnotesize\url{https://dcc-fm.github.io/sv2526/exercises/adventurers/adventurers-tutorial-mcrl2.zip}
  %   % //
  % }
\end{slide}
...
\begin{frame}[t]\frametitle{mCRL2 tutorial}
  ...
  \begin{alertblock}{}
  % \\
  % \structure{\url{https://dcc-fm.github.io/sv2526/exercises/adventurers/adventurers-tutorial-mcrl2.zip}}
  \structure{\url{https://fm-dcc.github.io/sv2526/exercises/adventurers/adventurers-tutorial-mcrl2.zip}}
  \end{alertblock}
\end{frame}
